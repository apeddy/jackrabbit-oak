...
// import static org.apache.jackrabbit.oak.segment.aws.util.AzureConfigurationParserUtils.KEY_ACCOUNT_NAME;
// import static org.apache.jackrabbit.oak.segment.aws.util.AzureConfigurationParserUtils.KEY_DIR;
// import static org.apache.jackrabbit.oak.segment.aws.util.AzureConfigurationParserUtils.KEY_STORAGE_URI;
// import static org.apache.jackrabbit.oak.segment.aws.util.AzureConfigurationParserUtils.parseAzureConfigurationFromUri;
...
public class ToolUtils {
    ...
    public static FileStore newFileStore(SegmentNodeStorePersistence persistence, File directory,
        ...
        FileStoreBuilder builder = FileStoreBuilder.fileStoreBuilder(directory).withCustomPersistence(persistence)
                .withMemoryMapping(false).withStrictVersionCheck(strictVersionCheck)
    ...
    public static SegmentNodeStorePersistence newSegmentNodeStorePersistence(SegmentStoreType storeType,
        ...
        switch (storeType) {
        case AWS:
            AwsContext awsContext = createAwsContext(pathOrUri.substring(3));
    ...
    public static SegmentArchiveManager createArchiveManager(SegmentNodeStorePersistence persistence) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Could not access AWS S3. Please verify the path provided!");
        }

        return archiveManager;
    }

    public static AwsContext createAwsContext(String path) {
        ...
        String region = null;
        String gcLogStream = null;
        String journalStream = null;
        String lockStream = null;
        return AwsContext.create(credentialsProvider, bucketName, rootDirectory, region, gcLogStream, journalStream,
                lockStream);
    }
