 ...
 */
package org.apache.jackrabbit.oak.segment.aws.util;

import static org.apache.jackrabbit.oak.segment.aws.util.AwsConfigurationParserUtils.AwsConnectionKey.*;
 ...
 * standard URI.
 */
public class AwsConfigurationParserUtils {
    public enum AwsConnectionKey {
    ...
    private AwsConfigurationParserUtils() {
     ...
     */
    public static boolean isCustomAwsConnectionString(String conn) {
     ...
     */
    public static Map<String, String> parseAwsConfigurationFromCustomConnection(String conn) {
        Map<AwsConnectionKey, String> tempConfig = new HashMap<>();

        String[] connKeys = conn.split(";");
        for (AwsConnectionKey key : AwsConnectionKey.values()) {
     ...
     * (key names in bold)
     */
    public static Map<String, String> parseAwsConfigurationFromUri(String uriStr) {
        Map<String, String> config = new HashMap<>();
