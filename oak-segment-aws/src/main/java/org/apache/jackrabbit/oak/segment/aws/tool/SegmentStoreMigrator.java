...
import static org.apache.jackrabbit.oak.segment.aws.tool.ToolUtils.fetchByteArray;
import static org.apache.jackrabbit.oak.segment.aws.tool.ToolUtils.storeDescription;

import org.apache.jackrabbit.oak.commons.Buffer;
import org.apache.jackrabbit.oak.segment.aws.AwsContext;
import org.apache.jackrabbit.oak.segment.aws.AwsPersistence;
import org.apache.jackrabbit.oak.segment.aws.tool.ToolUtils.SegmentStoreType;
...
public class SegmentStoreMigrator implements Closeable  {
    ...
    public static class Builder {
        ...
        public Builder withSource(AwsContext awsContext) throws URISyntaxException {
            this.source = new AwsPersistence(awsContext);
            this.sourceName = storeDescription(SegmentStoreType.AWS, awsContext.bucketName + "/" + awsContext.rootDirectory);
            return this;
        }
        ...
        public Builder withTarget(AwsContext awsContext) throws URISyntaxException {
            this.target = new AwsPersistence(awsContext);
            this.targetName = storeDescription(SegmentStoreType.AWS, awsContext.bucketName + "/" + awsContext.rootDirectory);
            return this;
        }
