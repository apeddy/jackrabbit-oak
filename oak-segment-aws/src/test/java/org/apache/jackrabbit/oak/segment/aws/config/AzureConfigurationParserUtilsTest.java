 ...
 */
package org.apache.jackrabbit.oak.segment.aws.config;

import static org.apache.jackrabbit.oak.segment.aws.util.AwsConfigurationParserUtils.KEY_ACCOUNT_NAME;
import static org.apache.jackrabbit.oak.segment.aws.util.AwsConfigurationParserUtils.KEY_CONNECTION_STRING;
import static org.apache.jackrabbit.oak.segment.aws.util.AwsConfigurationParserUtils.KEY_CONTAINER_NAME;
import static org.apache.jackrabbit.oak.segment.aws.util.AwsConfigurationParserUtils.KEY_DIR;
import static org.apache.jackrabbit.oak.segment.aws.util.AwsConfigurationParserUtils.KEY_STORAGE_URI;
...
import org.apache.jackrabbit.oak.segment.aws.util.AwsConfigurationParserUtils;
...
public class AzureConfigurationParserUtilsTest {
    ...
    //     assertTrue(AwsConfigurationParserUtils.isCustomAwsConnectionString(conn.toString()));

    //     Map<String, String> config = AwsConfigurationParserUtils.parseAwsConfigurationFromCustomConnection(conn.toString());
    ...
    //     assertFalse(AwsConfigurationParserUtils.isCustomAwsConnectionString(uri));

    //     Map<String, String> config = AwsConfigurationParserUtils.parseAwsConfigurationFromUri(uri);
