...
public class AzureGCJournalTest extends GcJournalTest {
    ...
    protected SegmentNodeStorePersistence getPersistence() throws Exception {
        ...
        AwsContext awsContext = AwsContext.create(s3, bucketName, "oak", kinesis, "gclogstream", "journalstream", "lockstream");
    ...
    public void testGCGenerationCompactedFlagCleared() throws Exception {
        super.testGCGenerationCompactedFlagCleared();
    }
